<div class="container-fluid footer py-3 wow fadeIn" data-wow-delay="0.2s">
    <div class="container py-3">
        <div class="row g-3">
                        ...
                        <div class="col-md-9 col-lg-9 col-xl-9">
                            <div class="footer-item">
                                <a href="index.html" class="p-0">
                                    <img src="../includes/img/TMClogo2.png " style="width:350px;height:auto;"
                                        alt="Logo">
                                </a>
                                <p class="text-white mb-4">At Tyler Madison Consulting, LLC, we bridge the gap between
            ...
            <div class="col-xl-3">
                <div class="footer-item">
                    <h4 class="text-white mb-4">Stay Updated with Our Newsletter!</h4>
