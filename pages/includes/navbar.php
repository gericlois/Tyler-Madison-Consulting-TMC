                        ...
                        <div class="nav-btn px-3">
                            ...
                            <?php else: ?>
                                <div class="btn-group ms-3">
                                    <button type="button" class="btn btn-primary rounded-pill py-2 px-4 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                        Login
                                    </button>
                ...
                <div class="d-none d-xl-flex flex-shrink-0 ps-4">
                    ...
                    <div class="d-flex flex-column ms-3">
                        <?php if (isset($_SESSION['user_id'])): ?>
                            ...
                            <span class="text-dark"><?php echo htmlspecialchars($_SESSION['role']); ?></span>
                        <?php else: ?>
                            <span>Guest</span>
